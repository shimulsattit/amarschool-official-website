...
export const Route = createFileRoute("/services/web-development")({
  head: () => ({
    meta: [
      { title: "Web Development Service — Amar School" },
      {
        name: "description",
        content:
          "Custom website, eCommerce and WordPress development with Next.js, Node, React and Laravel. Fast delivery, on-page SEO and 3 months free support.",
      },
      { property: "og:title", content: "Web Development Service — Amar School" },
      {
        property: "og:description",
        content: "Custom websites built with Next.js, React, Node and Laravel.",
      },
    ],
  }),
