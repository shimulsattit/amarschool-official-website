...
export const Route = createFileRoute("/services/graphics-design")({
  head: () => ({
    meta: [
      { title: "Graphics Design Service — Amar School" },
      {
        name: "description",
        content:
          "Logo, business card, brochure, t-shirt and social media design for brands in Bangladesh. Custom graphics that convert.",
      },
      { property: "og:title", content: "Graphics Design Service — Amar School" },
      {
        property: "og:description",
        content: "Logo, brochure, social media and brand design services.",
      },
    ],
  }),
