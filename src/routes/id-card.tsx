...
export const Route = createFileRoute("/id-card")({
  head: () => ({
    meta: [
      { title: "School ID Card Design & Printing — Amar School" },
      {
        name: "description",
        content:
          "Ready made school and college ID card designs with QR code, barcode and biometric support. Bulk design and printing from Amar School.",
      },
      { property: "og:title", content: "School ID Card Design & Printing" },
      {
        property: "og:description",
        content: "Hundreds of ID card templates with QR, barcode and RFID support.",
      },
    ],
  }),
  component: IdCard,
